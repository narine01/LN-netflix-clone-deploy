        ...
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            <img className="
                ...
                <div className="opacity-0 absolute top-0 transition duration-200 z-10 invisible sm:visible delay-300 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw] group-hover:opacity-100">
                    ...
                    <div className="z-10  bg-zinc-800 p-2 lg:p-4 absolute  w-full translate shadow-md rounded-b-md">
                        <div className="flex flex-row items-center gap-3">
                            ...
                            <div onClick={() => openModal(data?.id)} className="cursor-pointer ml-auto w-6 group/item lg:w-10 lg:h-10 border-white border-2 rounded-full flex justify-center items-center transition hover:border-neutral-300 ">

                                <BiChevronDown size={35} className="text-white group-hover/item-neutral-300 w-4"/>
                            </div>
                        </div>
